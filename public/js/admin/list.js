document.addEventListener('DOMContentLoaded', () => {
    ...
    const actions = ['create', 'massDestroy', 'batch', 'checkin', 'publish', 'unpublish', 'testEmail', 'update', 'rebuild', 'renewal', 'exportList', 'renewalReminder'];
    ...
    renewal = function() {
        if (window.confirm(messages.confirm_renewal_process)) {
            window.location.href = document.getElementById('_renewal').value;
        }
    }

    exportList = function() {
        if (window.confirm(messages.export_list_confirmation)) {
            window.location.href = document.getElementById('_exportList').value;
        }
    }
    ...
    renewalReminder = function() {
        ...
        if (window.confirm(message)) {
            window.location.href = document.getElementById('_renewalReminder').value;
        }
    }
});
