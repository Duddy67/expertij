...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        @if (isset($metaData))
            @include('themes.expertij.partials.site.metadata')
        @endif
	...
	<div class="container">
	    ...
	    <header id="layout-header">
                @include('themes.expertij.partials.site.header')
	    </header>

	    <!-- Content -->
	    <section id="layout-content" class="pt-4">
                @include('themes.expertij.pages.'.$page['name'])
	    </section>

	    <!-- Footer -->
	    <footer id="layout-footer" class="page-footer pt-4">
                @include('themes.expertij.partials.site.footer')
	    </footer>
	</div>
    ...
    @include('themes.expertij.partials.cookie-info.index')
    </body>
</html>
