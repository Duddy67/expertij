<div class="row border border-success rounded p-3 m-3" id="attestation-{{ $i }}-{{ $j }}">
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            <input type="file" name="attestation__file_{{ $i }}_{{ $j }}" class="form-control" id="licences.{{ $i }}.attestations.{{ $j }}.attestation_file">
            <div class="text-danger" id="licences.{{ $i }}.attestations.{{ $j }}.attestation_fileError"></div>
        </div>
        <div class="col-md-6 form-group">
