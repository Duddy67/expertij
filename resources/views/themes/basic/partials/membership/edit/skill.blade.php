        ...
        <div class="col-md-6 form-group">
            <div class="mt-3">
                <div class="form-check form-check-inline">
                    ...
                    <input class="form-check-input language-skill" type="checkbox" data-type="interpreter" data-licence-index="{{ $i }}" data-attestation-index="{{ $j }}" data-skill-index="{{ $k }}" name="licences[{{ $i }}][attestations][{{ $j }}][skills][{{ $k }}][interpreter]" id="licences.{{ $i }}.attestations.{{ $j }}.skills.{{ $k }}.interpreter" {{ $checked }}>
                    <label class="form-check-label" for="licences.{{ $i }}.attestations.{{ $j }}.skills.{{ $k }}.interpreter">{{ __('labels.membership.interpreter') }}</label>
                </div>
                <div class="form-check form-check-inline">
                    @php $disabled = ($checked) ? '' : 'disabled'; @endphp
            ...
            <div class="">
                <div class="form-check form-check-inline">
                    ...
                    <input class="form-check-input language-skill" type="checkbox" data-type="translator" data-licence-index="{{ $i }}" data-attestation-index="{{ $j }}" data-skill-index="{{ $k }}" name="licences[{{ $i }}][attestations][{{ $j }}][skills][{{ $k }}][translator]" id="licences.{{ $i }}.attestations.{{ $j }}.skills.{{ $k }}.translator" {{ $checked }}>
