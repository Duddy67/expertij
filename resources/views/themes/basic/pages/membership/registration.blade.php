        ...
        <div class="tab-content">
            <div class="tab-pane active" id="personal_information">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="birth_date" class="form-control date" id="birth_date" data-options="['startEmpty']" data-date="0" data-format="d M Y" readonly>
            ...
            <div class="tab-pane" id="licences">
                ...
                <div class="form-group" id="licence-container" data-latest-index="{{ $i }}">
                    @include('themes.basic.partials.membership.registration.licence')
