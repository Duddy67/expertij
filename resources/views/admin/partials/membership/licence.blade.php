<div class="row border border-primary rounded p-3 mt-3" id="licence-{{ $i }}">
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            <select name="licences[{{ $i }}][court]" class="form-select" id="licences.{{ $i }}.court" disabled>
                <option value="">{{ __('labels.generic.select_option') }}</option>
        ...
        <div class="col-md-6 form-group">
            ...
            <select name="licences[{{ $i }}][appeal_court]" class="form-select" id="licences.{{ $i }}.appeal_court" disabled>
                <option value="">{{ __('labels.generic.select_option') }}</option>
