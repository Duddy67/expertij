<tr class="align-middle" id="row-document-{{ $document->id }}">
  ...
  <td>
      ...
      <button type="button" class="btn btn-success document-management" data-action="replace" data-document-id="{{ $document->id }}">Remplacer</button>
  </td>
  <td>
      ...
      <button type="button" class="btn btn-danger document-management" data-action="delete" data-document-id="{{ $document->id }}">delete</button>
  </td>
</tr>
