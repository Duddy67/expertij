        ...
        <aside id="sidebar" class="js-sidebar sidebar-disabled">
            ...
            <div class="h-100">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <div class="sidebar-main-item {{ $active }}">
                            <a href="#" class="sidebar-link collapsed" data-bs-target="#memberships" data-bs-toggle="collapse"
                                aria-expanded="false"><i class="far fa-address-card pe-2"></i>
                                @lang ('labels.title.memberships')
                            </a>
                        </div>
                        @php $show = ($active) ? 'show' : '' @endphp
                        <ul id="memberships" class="sidebar-dropdown list-group list-group-flush list-unstyled collapse {{ $show }}" data-bs-parent="#sidebar">
                            @php $active = ($routeName == 'admin.memberships.index' || $routeName == 'admin.memberships.create' || $routeName == 'admin.memberships.edit') ? 'active' : '' @endphp
                            <li class="list-group-item list-group-item-action {{ $active }}">
